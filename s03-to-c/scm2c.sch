...
(define def
   (call-with-input-file "prelude.sch"
    (lambda(ip)
      (let [(primitives (read ip))]
	(cdr primitives)))))
...
(define (maketests)
  ...
  (compit "examples/test13.scm" "test13.c")
  (compit "examples/test14.scm" "test14.c")
  (compit "examples/test15.scm" "test15.c")
  (compit "examples/test16.scm" "test16.c")
  (compit "examples/test17.scm" "test17.c")
